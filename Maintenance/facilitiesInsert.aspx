<%@ Page Title="Tanghalang Pasigueño" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="facilitiesInsert.aspx.cs" Inherits="facilities" %>
  ...
  <legend>Facilities Maintenance</legend>
    <table class="style1">
        ...
        <td>
            Description:</td>
        <td>
            <asp:TextBox ID="TextBox2" runat="server" Height="51px" Width="181px" 
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          <InsertParameters>
              <asp:ControlParameter ControlId='TextBox1' PropertyName='Text'  Name="FacilityName" Type="String" />
