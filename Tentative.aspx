<%@ Page Title="Tanghalang Pasigueño" Language="C#" MasterPageFile="~/Site3.master" AutoEventWireup="true" CodeFile="Tentative.aspx.cs" Inherits="Tentative" %>
...
<fieldset title="sdas">
    <legend>List of Tentative Reservations</legend>
    <br />
    <table align="center">
        <tr>
    ...
    <table border="1" align=center cellpadding="5">
        <tr>
            ...
            <th class="style1">Letter of Intent</th>
        ...
        <tr>
            ...
            <td align="center" class="link">Download</td>
            <td align="center" class="link">View</td>
        </tr>
        <tr>
            <td>Seminar</td>
