...
public partial class client_EventInfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (tagg == 6)
        {
            balanceHide.Visible = true;
            tag5Hide.Visible = false;
            Billing2hide.Visible = true;
        }

        LinkButton1.Attributes.Add("onclick", "window.open('../2ndBill.aspx?ReservationId=" + Request.QueryString["ReservationId"] + "', 'newwindow','menubar=1,resizable=1,width=700,height=900');return false;");
    }
    ...
    {
        Response.Redirect("~/Client/rfr.aspx?ReservationId=" + Request.QueryString["ReservationId"]);
    }
    protected void rs2_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Client/rfr.aspx?ReservationId=" + Request.QueryString["ReservationId"] + "&tag=" +tagg);
    }
