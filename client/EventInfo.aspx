<%@ Page Title="Tanghalang Pasigueño" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EventInfo.aspx.cs" Inherits="client_EventInfo" %>
...
<legend>Reservation Details</legend>
    ...
    <div ID="balance" runat="server">
        ...
        <div id="Billing2hide" runat="server">
        <fieldset>
        <legend>Second Billing</legend>
            <p style="text-align:center"><asp:LinkButton ID="LinkButton1" runat="server" Font-Size="20pt">View 2nd Billing</asp:LinkButton></p>
        </fieldset>
        </div>
    </div>
...
<table>            
    <tr>
        <td>       
            <asp:Button ID="rs1" runat="server" Text="Request For Reschedule Of Reservation" 
            width="294px" onclick="Button2_Click"/>
            <asp:Button ID="rs2" runat="server" Text="Reschedule Reservation" width="294px" 
                onclick="rs2_Click"/>
        </td>
        <td>
