<%@ Page Title="Tanghalang Pasigueño" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="ReleaseContract.aspx.cs" Inherits="Admin_RFC" %>
...
<br /><br />
    <div class="notif">Contract</div><br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Reservationid" 
                DataNavigateUrlFormatString="~/Admin/ReleaseContract.aspx?ReservationId={0}" Text="View" />
        </Columns>
   ...
   <div>
    ...
    <div style="width:300px;float:right;text-align:center" id="EOS" runat="server" >
        ...
        <br />
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="20px">Printable Contract</asp:LinkButton>
                    <br />
        <br />
