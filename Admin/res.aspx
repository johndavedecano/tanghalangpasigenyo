...
<body>
    ...
    <div class="wrapper">
        <div>
          <div class="header">
            <div class="x1">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Resources/rizal logo.png" />
            </div>
            <div class="x2">
            <span>Republic of the Philippines</span><br />
            <span>Rizal Provincial Government</span><br />
            <span>Antipolo City</span><br />
            </div>
            <div class="x3">
            &nbsp;
            </div>
       ...
       <br />&nbsp;
        <div style="border: 1px solid black">
            ...
            <div>&nbsp;<br />&nbsp;</div>
            <div>
                <div style="width:80px;float: left">Recieved By:</div>
                <div style="width:164px;float:left;  border-bottom:1px solid black">&nbsp;</div>
                <div style="width:8px;float:left;">&nbsp;</div>
                <div style="width:144px;float: left;  border-bottom:1px solid black">
                ...
                <div style="width:8px;float:left;">&nbsp;</div>
                <div style="width:144px;float: left; text-align:center">Print Name</div> 
            </div>
