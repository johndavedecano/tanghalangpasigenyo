<%@ Page Title="Tanghalang Pasigueño" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="Confirmed.aspx.cs" Inherits="Admin_RFC" %>
...
<div style="border-color: #FF3300;">
<br />
<br />
    <div class="notif">Confirmed Reservation</div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Reservationid" 
                DataNavigateUrlFormatString="~/Admin/Confirmed.aspx?ReservationId={0}" Text="View" Visible="False" />
        </Columns>
     ...
     <fieldset style="border-color: #FF3300">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ReservationId" 
            ...
            <ItemTemplate>
                ...
                <div class="labels">ReservationId:</div>
                <div class="fields">
                ...
                <div class="labels">Grand Total:</div>
                <div class="fields">
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ClientContactNo" HeaderText="ClientContactNo" 
                SortExpression="ClientContactNo" />
            <asp:HyperLinkField DataNavigateUrlFields="Reservationid" 
                DataNavigateUrlFormatString="~/Admin/Confirmed.aspx?ReservationId={0}" Text="View" />
        </Columns>
        <PagerStyle CssClass="pgr" />
    </asp:GridView></div>
