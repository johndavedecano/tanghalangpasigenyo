<%@ Page Title="Tanghalang Pasigueño" Language="C#" AutoEventWireup="true" CodeFile="CancelledReportYSA.aspx.cs" Inherits="Reports_AmenitiesReport" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="CancelledYSA.rpt">
            </Report>
