<%@ Page Title="Tanghalang Pasigueño" Language="C#" AutoEventWireup="true" CodeFile="FacilityReportYSA.aspx.cs" Inherits="Reports_AmenitiesReport" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="FacilityYSA.rpt">
            </Report>
