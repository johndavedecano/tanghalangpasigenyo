<%@ Page Title="Tanghalang Pasigueño" Language="C#" AutoEventWireup="true" CodeFile="BalanceReportYSA.aspx.cs" Inherits="Reports_AmenitiesReport" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="BalanceYSA.rpt">
            </Report>
