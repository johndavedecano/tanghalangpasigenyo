<%@ Page Title="Tanghalang Pasigueño" AutoEventWireup="true" CodeFile="IncomeReportYSA.aspx.cs" Inherits="Reports_AmenitiesReport" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <div>
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
            ...
            ToolPanelWidth="200px" Width="350px" oninit="CrystalReportViewer1_Init" />
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="IncomeYSA.rpt">
            </Report>
